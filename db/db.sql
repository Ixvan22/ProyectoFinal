...
-- Tiempo de generación: 10-06-2024 a las 19:52:49
...
('00000000Z', '$2y$10$QgxUK61915vXwBAsiLhAeOiFAAVVNlc7KAgyHFlOp7hQ4xABtHgzq');
...
('00000000Z', 'Admin', 'Admin', 600000000, 'admin@tesseract-solutions.com', 19500101, 19500101, 1);
...
--
ALTER TABLE `mercancia`
  MODIFY `localizador` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `transporte_mercancia`
--
ALTER TABLE `transporte_mercancia`
  MODIFY `localizador` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
